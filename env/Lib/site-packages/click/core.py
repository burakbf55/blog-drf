...
class MultiCommand(Command):
    ...
    def resultcallback(self, replace: bool = False) -> t.Callable[[F], F]:
        ...
        warnings.warn(
            "'resultcallback' has been renamed to 'result_callback'." " The old name will be removed in Click 8.1.",
            DeprecationWarning,
            stacklevel=2,
        )
...
class Parameter:
    ...
    def __init__(
        ...
        autocompletion: t.Optional[
            t.Callable[[Context, t.List[str], str], t.List[t.Union[t.Tuple[str, str], str]]]
        ] = None,
    ) -> None:
        ...
        if autocompletion is not None:
            ...
            def shell_complete(ctx: Context, param: "Parameter", incomplete: str) -> t.List["CompletionItem"]:
                from click.shell_completion import CompletionItem
