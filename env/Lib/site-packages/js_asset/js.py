...
class JS(object):
    ...
    def __repr__(self):
        return "JS({}, {}, static={})".format(self.js, json.dumps(self.attrs, sort_keys=True), self.static)

    def __html__(self):
        js = static(self.js) if self.static else self.js
        return format_html('{}"{}', js, mark_safe(flatatt(self.attrs)))[:-1] if self.attrs else js

    def __eq__(self, other):
        if isinstance(other, JS):
            return self.js == other.js and self.attrs == other.attrs and self.static == other.static
