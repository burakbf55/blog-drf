    ...
    if hasattr(settings, "CKEDITOR_FILENAME_GENERATOR"):
        ...
        try:
            ...
            try:
                ...
                warnings.warn(
                    "Update %s() to accept the arguments `filename, request`." % settings.CKEDITOR_FILENAME_GENERATOR
                )
            else:
                warnings.warn(
                    "Update %s() to accept a second `request` argument." % settings.CKEDITOR_FILENAME_GENERATOR,
