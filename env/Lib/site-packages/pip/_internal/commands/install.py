    ...
    def run(self, options, args):
        ...
        try:
            ...
            for result in installed:
                item = result.name
                try:
                    installed_version = get_installed_version(result.name, working_set=working_set)
...
def get_lib_location_guesses(
    ...
    # type:(...) -> List[str]
    scheme = distutils_scheme("", user=user, home=home, root=root, isolated=isolated, prefix=prefix)
