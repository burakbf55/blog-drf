...
if MYPY_CHECK_RUNNING:
    from typing import Dict, Iterable, Iterator, List, Optional, Text, Tuple, Type, Union, Mapping, Any
...
def call_subprocess(
    ...
    if proc_had_error:
        ...
        exc_msg = ("Command errored out with exit status {}: {} " "Check the logs for full command output.").format(
