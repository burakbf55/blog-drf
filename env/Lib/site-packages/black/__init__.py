...
from typing import Any, Dict, Generator, Iterator, List, MutableMapping, Optional, Pattern, Set, Sized, Tuple, Union
...
from black.mode import VERSION_TO_FEATURES, Feature, Mode, TargetVersion, supports_feature
from black.nodes import STARS, is_simple_decorator_expression, syms
...
def assert_equivalent(src: str, dst: str, *, pass_num: int = 1) -> None:
    ...
    try:
        ...
        raise AssertionError("cannot use --safe with this file; failed to parse source file.") from exc
