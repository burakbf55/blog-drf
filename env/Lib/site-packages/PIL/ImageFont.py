...
class FreeTypeFont:
    ...
    def __init__(self, font=None, size=10, index=0, encoding="", layout_engine=None):
        ...
        try:
            ...
            if freetype_version is not None and parse_version(freetype_version) < parse_version("2.8"):
                warnings.warn(
    ...
    def getsize_multiline(
        ...
        for line in lines:
            line_width, line_height = self.getsize(line, direction, features, language, stroke_width)
    ...
    def getmask2(
        ...
        **kwargs,
        ...
        self.font.render(text, im.id, mode, direction, features, language, stroke_width, ink)
        return im, offset
