    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def load(self):
        ...
        if self.im and self.palette and self.palette.dirty:
            ...
            if mode == "RGBA":
                ...
                arr = bytes(value for (index, value) in enumerate(arr) if index % 4 != 3)
    ...
    def resize(self, size, resample=None, box=None, reducing_gap=None):
        ...
        if resample is None:
            ...
            raise ValueError(message + " Use " + ", ".join(filters[:-1]) + " or " + filters[-1])
...
def open(fp, mode="r", formats=None):
    ...
    if mode != "r":
        ...
        raise ValueError("StringIO cannot be used to open an image. " "Binary data must be used instead.")
...
def _showxv(image, title=None, **options):
    ...
    if "_internal_pillow" in options:
        ...
        warnings.warn(
            "_showxv is deprecated and will be removed in Pillow 9 (2022-01-02). " "Use Image.show instead.",
            DeprecationWarning,
        )
    ...
    def tobytes(self, offset=8):
        ...
        for tag, value in self.items():
            if tag in [0x8769, 0x8225, 0x8825] and not isinstance(value, dict):
                ...
                if tag == 0x8769 and 0xA005 in value and not isinstance(value[0xA005], dict):
                    value = value.copy()
