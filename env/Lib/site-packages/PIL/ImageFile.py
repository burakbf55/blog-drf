...
def raise_ioerror(error):
    warnings.warn(
        "raise_ioerror is deprecated and will be removed in Pillow 9 (2022-01-02). " "Use raise_oserror instead.",
        DeprecationWarning,
    )
                        ...
                        while True:
                            ...
                            if not s:  # truncated jpeg
                                if LOAD_TRUNCATED_IMAGES:
                                    ...
                                    raise OSError("image file is truncated " f"({len(b)} bytes not processed)")
