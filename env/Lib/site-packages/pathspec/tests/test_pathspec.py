...
class PathSpecTest(unittest.TestCase):
    ...
    def test_01_addition(self):
        ...
        """
        first_spec = pathspec.PathSpec.from_lines("gitwildmatch", ["test.txt", "test.png"])
        second_spec = pathspec.PathSpec.from_lines("gitwildmatch", ["test.html", "test.jpg"])
        combined_spec = first_spec + second_spec
        results = set(combined_spec.match_files(["test.txt", "test.png", "test.html", "test.jpg"], separators=("\\",)))
    ...
    def test_02_addition(self):
        ...
        results = set(spec.match_files(["test.txt", "test.png", "test.html", "test.jpg"], separators=("\\",)))
        self.assertEqual(results, {"test.txt", "test.png", "test.html", "test.jpg"})
