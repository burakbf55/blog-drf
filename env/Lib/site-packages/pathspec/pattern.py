...
try:
    from typing import AnyStr, Iterable, Iterator, Optional, Pattern as RegexHint, Text, Tuple, Union
except ImportError:
    pass
    ...
    def match(self, files):
        ...
        *files* (:class:`~collections.abc.Iterable` of :class:`str`) contains
        ...
        raise NotImplementedError(
            "{}.{} must override match().".format(self.__class__.__module__, self.__class__.__name__)
        )
